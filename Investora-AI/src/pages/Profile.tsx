...
export default function Profile() {
  ...
  const [weeklyEmailDigest, setWeeklyEmailDigest] = useState(
    p?.weeklyEmailDigest ?? p?.dailyEmailDigest ?? false
  );
  ...
  const handleSave = async () => {
    ...
    try {
      const ok = await updateProfile({
        ...
        dailyEmailDigest: weeklyEmailDigest,
        weeklyEmailDigest,
        alertNotifications,
        email: email.trim(),
        // v3 fields
  ...
  const nameForInitials = user?.profile?.displayName?.trim() || user?.username || "??";
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="flex-1 px-6 py-5 space-y-5 max-w-2xl mx-auto w-full">
        ...
        <div className="flex items-center gap-4 py-1">
          ...
          <div>
            <p className="font-semibold text-foreground">{user?.profile?.displayName || user?.username}</p>
            ...
            <div className="space-y-3 pt-1 border-t border-border/50">
              <div className="flex items-center justify-between pt-3">
                ...
                <Switch
                  ...
                  onCheckedChange={setWeeklyEmailDigest}
                />
              </div>
